...
### 優化方向
- **改為**：段落內最小 inline 標記 …，段落末尾聚類，全文末尾彙總表
- **效果**：訊息流暢、易掃讀、專業感提升
...
### 1️⃣ 05_CITATION_POLICY_v2.0（核心政策）
**位置**：artifact_id:41  
**內容**：
- C1. 引用策略（段落內 … vs 末尾表）
- C2. 來源標記格式（統一規範）
...
```
1) 核心結論
目前產品市占率為 23%，預期今年成長到 28%。

【本段資料來源】
 McKinsey 2026 Market Report — https://example.com
 Industry Forecast 2026 — https://example.com

2) 依據
根據調查報告，消費者滿意度提升，推動購買意願。

【本段資料來源】
 Consumer Survey 2026 — https://example.com
 Brand Perception Study — https://example.com

3) 衝突檢查
來源 A 和來源 B 對數字有出入，差異原因為定義範圍不同。

【本段資料來源】
 Data Methodology Report A — https://example.com
 Data Methodology Report B — https://example.com

4) 風險與邊界
資料庫更新時間為 2026-01-15。

【本段資料來源】
 Database Update Log — https://example.com

---

【完整資料來源清單】
 McKinsey 2026 Market Report — 媒體 | https://example.com | 信度：[Industry]
 Industry Forecast 2026 — 機構 | https://example.com | 信度：[Official]
 Consumer Survey 2026 — 研究 | https://example.com | 信度：[Academic]
 Brand Perception Study — 公司 | https://example.com | 信度：[Industry]
 Data Methodology Report A — 新聞 | https://example.com | 信度：[Media]
 Data Methodology Report B — 新聞 | https://example.com | 信度：[Media]
 Database Update Log — 平台 | https://example.com | 信度：[Official]
```
...
**選做（參考）：**
3. 📖 讀一遍 （Citation Policy v2.0）理解新規則
4. 📖 讀一遍本手冊，掌握變更概况
...
| Citation Policy v2.0 | 新引用規範（優化 … + 末尾表） |
