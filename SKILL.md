...
| 前綴 | 來源 | 範例 |
|:----:|------|------|
| `[T1]` | 本地白話 RAG | `[T1]` 刑法 第 309 條 — 公然侮辱… |
...
Google Sheets（Legal_DB_Full_Part1）→ 每日凌晨 3:00 自動 sync → SQLite FTS5。
查詢工具：`rag.py`（47,001 條，零套件依賴，41.8 MB）。
...
| **ESSAY_TEST** | 申論題測試 | 法律申論出題+批改（三區溫度🔥0.8/0.7/0.1） |
...
| `[1]` | 聯網全國法規資料庫 | `[1]` law.moj.gov.tw — 刑法 第 309 條 |
| `[2]` | 司法院判決書查詢 | `[2]` judgment.judicial.gov.tw — 最高法院 95 台上… |
| `[3]` | 學術論文 / 教科書 | `[3]` 王澤鑑《民法總則》… |
...
| 法規現狀參考 | `docs/60_概念詞條/法規現狀參考表.md` |
| 概念詞條 | `docs/60_概念詞條/` |
| 封存參考 | `docs/80_封存參考/` |
| 維運治理 | `docs/90_維運治理/` |
